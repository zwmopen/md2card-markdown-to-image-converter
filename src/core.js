...
export function sanitizeFilename(value, fallback = 'MD2Card') {
...
export function extractTitle(markdown, fallback = 'MD2Card') {
...
export function splitMarkdown(markdown, maxChars = 650) {
...
export function estimatePageCapacity({ width = 400, height = 533, fontSize = 16, padding = 20 } = {}) {
...
export function sortMarkdownFiles(files) {
